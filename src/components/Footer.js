...
const Footer = () => {
  return (
    <motion.div initial={{opacity: 0 }} transition={{ease: "easeIn", duration: 1, delay: 1}} animate={{opacity: 1}} className="container d-flex justify-content-center align-items-center w-100 p-4">
