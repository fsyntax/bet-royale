      ...
      <div className="container d-flex flex-column align-items-center text-left pt-4 pb-4">
        <div>
          ...
          <p className="pt-3">
            ...
            need. You need both your Metamask wallet <br /> and Discord account
            in order to bet. In order to create bets, you just need your Discord
            account.
          </p>
          ...
          <p className="pt-3">
            ...
            in UTC time, <br /> so be aware of everyone's timezones when setting
            those parameters.
          </p>
